            ...
            categories.map((category,index)=>(
                  <div key={index} className="p-4 h-[424px]">
                       <div className="feature_image mb-4 relative">
                            <img className="w-full h-[424px] rounded-lg object-cover" src={category?.image} alt={category?.title}></img>
                             <div className="absolute bottom-0 left-0 w-full h-[85px] bg-[#000000] bg-opacity-50 flex-col justify-center p-4">
