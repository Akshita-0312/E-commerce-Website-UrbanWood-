        ...
        <div className="lg:container mx-auto">
          <div className="grid grid-cols-4">
            <div>
              ...
              <p className="text-base text-[#272343] font-inter font-normal mb-4 mx-w-[350px]">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque
                labore amet necessitatibus? Lorem ipsum dolor sit, amet
                consectetur adipisicing elit. Blanditiis perspiciatis aliquid
                iusto tenetur aut itaque?
            ...
            <div className="newsletter">
              ...
              >
                ...
                <button
                  type="submit"
                  className="text-base tex-white font-semibold capitalize w-[127px] h-[46px] bg-[#007580] rounded-lg"
                >
                  Subscribe
                </button>
              </form>
